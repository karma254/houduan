    ...
    <div class="liuyanban-add" v-loading="loading">
        <el-card class="box-card">
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                ...
                                <el-form-item label="投诉内容" prop="liuyanneirong" required :rules="[{required:true, message:'请填写留言内容'}]">
                                            <el-input type="textarea" v-model="form.liuyanneirong"></el-input>                                    </el-form-item>

                                <el-form-item label="投诉人" prop="liuyanren">
