...
<el-option v-for="m in difangfandianList" :value="m.mingcheng" :label="m.mingcheng"></el-option>
                                ...
                                <el-form-item label="参考票价" prop="piaojia" :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
                                            <el-input placeholder="输入参考票价" style="width:250px;" v-model="form.piaojia" />                                    </el-form-item>
